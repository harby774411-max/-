      ...
      if (found) {
        ...
        if ((found as any).name_ar && !found.nameAr) {
          found = {
             ...
             ingredientsAr: found.ingredients_ar,
             usageAr: found.usage_ar,
             size: found.size || '50 مل',
             price: Number(found.price_after) || Number(found.price_before) || 0,
             priceBefore: found.price_before ? Number(found.price_before) : undefined,
